...
public class DatePickerDialog: UIView {
  ...
  func deviceOrientationDidChange(notification: NSNotification) {
    ...
    dialogView.frame = CGRect(x: (frame.width - dialogSize.width) / 2, y: (frame.height - dialogSize.height) / 2, width: dialogSize.width, height: dialogSize.height)
  }
  
  /// Create the dialog view, and animate opening the dialog
  public func show(target: UIViewController? = nil, title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: Date = Date(), minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
  ...
  private func createContainerView() -> UIView {
    ...
    let dialogContainer = UIView(frame: CGRect(x: (frame.width - dialogSize.width) / 2, y: (frame.height - dialogSize.height) / 2, width: dialogSize.width, height: dialogSize.height))
    ...
    self.titleLabel.font = UIFont(name: "PTSans-Bold", size: 16)
  ...
  private func addButtonsToView(container: UIView) {
    ...
    self.cancelButton.titleLabel!.font = UIFont(name: "PTSans-Regular", size: 16)!
    ...
    self.doneButton.titleLabel!.font = UIFont(name: "PTSans-Regular", size: 16)!
